				...
				<div class="container container-xl-custom  align-item-center pt-4 pb-3">
					<div class="row py-5 ">
						<div class="col-md-3 col-lg-2 mb-4 mb-lg-0">
							...
							<a href="index.php">
								<img alt="invictus" width="150" height="40" src="Images/invictus/invictus-logo-footer.png">
							</a>
							</div><br/>
						...
						<div class="col-md-3 col-lg-4 ">
							...
							<ul class="social-icons pb-3 social-icons-clean social-icons-medium">
								<li>
									<a href="https://www.instagram.com/invictus_diamantwerkzeuge/" target="_blank"><i class="fab fa-instagram"></i></a>
								</li>
								<li>
