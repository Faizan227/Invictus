						...
						<div class="container">
							<div class="header-row">
								<div class="header-column justify-content-start">
									<div class="header-row">
										<ul class="header-social-icons social-icons social-icons-clean social-icons-medium position-relative right-7  d-md-block ms-0">
											...
											<li class="social-icons-twitter"><a href="http://www.twitter.com/invictussener" target="_blank" title="Twitter"><i class="fab fa-twitter"></i></a></li>
											<li class="social-icons-facebook"><a href="http://www.facebook.com/invictusdiamantwerkzeuge" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
										</ul>
										<ul class="nav nav-pills position-relative bottom-1 ms-md-3">
											<li class="nav-item">
												<span class="d-flex   d-md-block  align-items-center ws-nowrap text-color-secondary font-weight-medium time-d-none "><i class="icon-clock icons text-3 top-3 left-1 me-2 text-color-secondary font-weight-bold"></i> Mo - Fr 8:00 - 18:00 Uhr Sa 9:00 - 15:00 Uhr <br/> Telefonisch erreichbar  </span>
												<!-- <span class="d-flex  d-md-block align-items-center ws-nowrap text-color-secondary font-weight-medium text-3"><i class="icon-clock icons text-3 top-3 left-1 me-2 text-color-secondary font-weight-bold"></i> Mo - Fr 8:00 - 18:00 Uhr Sa 9:00 - 15:00 Uhr <br/> Telefonisch erreichbar </span> -->
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="index.php">
											<img src="images/invictus/invictus-logo-head.png" class="img-fluid" width="180" height="59.60" alt="" />
										</a>
									</div>
								</div>
							</div>
								...
								<div class="header-row">
										...
										<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown ">
														<a class="nav-link dropdown-toggle <?php if($page=='product'){ echo 'active';} ?>" href="services.php" >
														Produkte
														</a>
									...
									<div class="feature-box feature-box-style-2 align-items-center ms-lg-4">
										...
										<div class="feature-box-info ps-2">
											...
											<a href="tel:+49201433 95 601" class="text-color-tertiary text-2 text-md-4 text-color-hover-primary text-decoration-none font-weight-bold line-height-1  pb-0">+49 201 43395601</a>
										</div>
									</div>
