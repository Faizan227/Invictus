<div class="header-outer bg-transparent">
<div class="container ">
    <div class="row">
...
<nav class="navbar navbar-expand-lg navbar-light  ">
    ...
    <div class="">
            ...
            <a href="home.php" class="text-decoration-none navbar-brand" > <img src="../images/invictus/invictus-logo-head.png" width="200" height="" alt=""> </a>
        </div>
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav ms-md-5 ps-md-5 mb-2 mb-lg-0">
                <li class="nav-item">
