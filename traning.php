				...
				<div class="container my-5 pb-2">
					<div class="row align-items-center mb-4">
						<div class="col-lg-12 mb-5 mb-lg-0">
							...
							Individuelle Schulungen und Workshops für Fachhändler
								</h3>
					...
					<div class="container pt-4 pb-3 mt-5">
						<div class="row align-items-center justify-content-center pt-3">
							...
							<div class="col-xl-3 text-center text-xl-end">
								<div class="position-relative">
									<a href="contact.php" class="btn btn-secondary btn-modern font-weight-bold text-3 btn-px-4 py-3">BOOK NOW IN 60 SECONDS</a>
								</div>
							</div>
						</div>
					</div>
...
>>>>>>> c0f81e02e4f1fae62dff29e983019d9f749ae4eb
